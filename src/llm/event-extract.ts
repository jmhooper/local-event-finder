...
6. **Infer missing data carefully** — if an optional field cannot be reliably determined from the content, omit it from the JSON object entirely. Do not emit \`null\` and do not fabricate information.
...
- \`description\`: A clean plain text summary or description of the event. Omit if no description can be found.
